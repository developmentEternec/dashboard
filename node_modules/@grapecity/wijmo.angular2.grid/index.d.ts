...
export declare class WjFlexGridColumn extends wjcGrid.Column implements OnInit, OnDestroy, AfterViewInit {
    ...
    ngAfterViewInit(): void;
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<WjFlexGridColumn, [null, null, { optional: true; skipSelf: true; }, null]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<WjFlexGridColumn, "wj-flex-grid-column", never, { "asyncBindings": "asyncBindings"; "wjProperty": "wjProperty"; "name": "name"; "dataMap": "dataMap"; "dataType": "dataType"; "binding": "binding"; "sortMemberPath": "sortMemberPath"; "format": "format"; "cellTemplate": "cellTemplate"; "header": "header"; "width": "width"; "maxLength": "maxLength"; "minWidth": "minWidth"; "maxWidth": "maxWidth"; "align": "align"; "allowDragging": "allowDragging"; "allowSorting": "allowSorting"; "allowResizing": "allowResizing"; "allowMerging": "allowMerging"; "aggregate": "aggregate"; "isReadOnly": "isReadOnly"; "cssClass": "cssClass"; "isContentHtml": "isContentHtml"; "isSelected": "isSelected"; "visible": "visible"; "wordWrap": "wordWrap"; "multiLine": "multiLine"; "mask": "mask"; "inputType": "inputType"; "isRequired": "isRequired"; "showDropDown": "showDropDown"; "dataMapEditor": "dataMapEditor"; "dropDownCssClass": "dropDownCssClass"; "quickAutoSize": "quickAutoSize"; "editor": "editor"; }, { "initialized": "initialized"; "isSelectedChangePC": "isSelectedChange"; }, never, ["*"]>;
}
/**
...
export declare class WjFlexGridCellTemplate implements ngCore.OnInit, ngCore.OnDestroy {
    ...
    */
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<WjFlexGridCellTemplate, [null, { optional: true; }, null, { optional: true; skipSelf: true; }, null, null]>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDefWithMeta<WjFlexGridCellTemplate, "[wjFlexGridCellTemplate]", ["wjFlexGridCellTemplate"], { "wjFlexGridCellTemplate": "wjFlexGridCellTemplate"; "cellTypeStr": "cellType"; "cellOverflow": "cellOverflow"; "valuePaths": "valuePaths"; "autoSizeRows": "autoSizeRows"; "forceFullEdit": "forceFullEdit"; }, {}, never>;
}
...
export declare class WjGridModule {
    static ɵmod: ɵngcc0.ɵɵNgModuleDefWithMeta<WjGridModule, [typeof WjFlexGrid, typeof WjFlexGridColumn, typeof WjFlexGridCellTemplate], [typeof ɵngcc1.CommonModule], [typeof WjFlexGrid, typeof WjFlexGridColumn, typeof WjFlexGridCellTemplate]>;
    static ɵinj: ɵngcc0.ɵɵInjectorDef<WjGridModule>;
}
